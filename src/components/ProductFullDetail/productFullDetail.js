                ...
                <div className={classes.container}>
                    ...
                    <div className={`${classes.right} ${classes.col}`}>
                        <section className={classes.attrSale}>
                            <span className={classes.attrName}>Trả góp 10%</span>
                            <span className={classes.attrName}>Giảm 5.000.000đ</span>
                        </section>
                        ...
                        <section className={classes.description}>
                            ...
                            <span className={classes.viewMoreText} onClick={() => { }}>Xem thêm ....</span>
                        </section>
                        ...
                        <section className={classes.promotion}>
                            <h3 classes={classes.headingT}>Ưu đãi</h3>
                            <Promotion />
